Attribute VB_Name = "initIP"
'Dieses Modul wurde ursprünglich nicht von mir geschrieben.
'Es dient dazu, die IPs des Rechners herauszufinden
...
Public Sub getIPs()
  ...
  Do
    ...
    anzIPs = anzIPs + 1
    ReDim Preserve IP(anzIPs - 1)
    IP(anzIPs - 1) = ip_address
